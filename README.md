...
```javascript
rcbrtf = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-rcbrtf@v0.0.1-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-rcbrtf@v0.0.1-umd/browser.js"></script>
```
