...
```javascript
import rcbrtf from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-rcbrtf@v0.0.2-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/math-base-special-rcbrtf/actions/workflows/test.yml/badge.svg?branch=v0.0.2
[test-url]: https://github.com/stdlib-js/math-base-special-rcbrtf/actions/workflows/test.yml?query=branch:v0.0.2
